...
@Configuration
@EnableJpaRepositories(basePackages = "lk.ijse.carRentalSystem.repo") // should link where we are going to write our queries
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds, JpaVendorAdapter vad){
       //This is the spring data jpa main object which handles all the features
        ...
        factory.setPackagesToScan("lk.ijse.carRentalSystem.entity");// set entity records location to the Spring Data JPA
        return factory;
    }
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/car_rental_db?createDatabaseIfNotExist=true");
        return ds;
    }
